...
import { SellerProfile } from '@/components/tickets/SellerProfile';
...
export default async function TicketPreviewPage({ params }: TicketPreviewPageProps) {
  ...
  const { ticket, event, seller } = data;
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="grid gap-6 lg:grid-cols-3">
          ...
          <div className="space-y-6 lg:col-span-2">
            ...
            {/* Profil vendeur (mobile, affiché en bas sur mobile) */}
          ...
          <div className="space-y-6">
            ...
            {/* Profil vendeur (desktop uniquement) */}
