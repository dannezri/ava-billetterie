...
const footerLinks = {
  product: {
    title: 'Produit',
    links: [
      { label: 'Acheter des billets', href: '/tickets' },
      { label: 'Vendre mes billets', href: '/sell' },
    ...
    <footer className="border-t border-zinc-200 bg-white dark:border-zinc-800 dark:bg-zinc-950">
      <div className="container mx-auto px-4 py-12 md:py-16">
        ...
        <div className="flex flex-col items-center justify-between gap-4 md:flex-row">
          <div className="text-center text-sm text-zinc-600 dark:text-zinc-400 md:text-left">
            © {currentYear} Ava. Tous droits réservés.
          </div>
