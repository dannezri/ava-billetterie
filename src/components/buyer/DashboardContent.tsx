          ...
          {data.upcomingConcerts.length === 0 ? (
            ...
            <div className="space-y-4">
              {data.upcomingConcerts.map((concert) => (
                ...
                >
                  {concert.ticket.event.imageUrl && (
                    <img
                      src={concert.ticket.event.imageUrl}
                  ...
                  <div className="flex-1 min-w-0">
                    ...
                    <div className="flex items-center gap-2 mt-2">
                      <Badge variant="secondary">
                        {format(new Date(concert.ticket.event.eventDate), 'PPP', { locale: fr })}
                      </Badge>
                  ...
                  {concert.status === 'ESCROWED' && concert.escrowReleaseDate && (
