    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>Sécurisez votre compte en vérifiant votre identité</CardDescription>
        </CardHeader>
        {!profile.verifiedIdentity && (
          <CardContent>
            <Alert>
              ...
              <AlertDescription>
                Votre identité n&apos;est pas encore vérifiée. Complétez la vérification KYC pour
                renforcer la confiance de votre profil.
              </AlertDescription>
            </Alert>
          </CardContent>
        )}
