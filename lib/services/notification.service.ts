...
export class NotificationService {
  ...
  /**
   * Notifie tous les abonnés d'un événement qu'un nouveau billet est disponible
   */
  static async notifyEventFollowers(eventId: string, ticketId: string, price: number, category: string) {
...
// Compat: exports fonctionnels pour les anciens imports
...
export const getNotifications = (
  userId: string,
  filters: { unread?: boolean; page?: number; limit?: number; type?: NotificationType }
) => {
